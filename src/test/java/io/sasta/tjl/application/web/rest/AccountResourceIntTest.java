...
import io.sasta.tjl.application.repository.AuthorityRepository;
...
import io.sasta.tjl.application.web.rest.errors.ExceptionTranslator;
import io.sasta.tjl.application.web.rest.vm.KeyAndPasswordVM;
import io.sasta.tjl.application.web.rest.vm.ManagedUserVM;
...
@SpringBootTest(classes = VcSampleApplicationApp.class)
